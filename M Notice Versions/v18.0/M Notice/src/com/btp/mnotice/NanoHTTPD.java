...
public abstract class NanoHTTPD {
	 ...
	 * @return a map of <code>String</code> (parameter ) to
	 *         <code>List&lt;String&gt;</code> (a list of the values supplied).
	 */
	...
	public static class DefaultTempFile implements TempFile {
		...
		public DefaultTempFile(String tempdir) throws IOException {
			//file = File.createTempFile(name, ".txt", new File(tempdir));
	...
	protected class HTTPSession {
		...
		public void execute() throws IOException {
			try {
				...
				// if(parms.get("ready")!=null) name = "Setting"; else name =
				// "result";
				...
				// Ok, now do the serve()
				/*
				 * Map<String, String> temp_parm= this.getParms(); if(
				 * temp_parm.get("ready") != null ) new
				 * classget(temp_parm.get("ready").toString());
				 */
				// if(parms.get("ready"))
		...
		private void parseBody(Map<String, String> files) throws IOException,
			...
			try {
				...
				//File setting = new File("/sdcard/setting.txt");
				//setting.delete();
